...
class CounterBloc extends Bloc<CounterEvent, CounterState> {
  CounterBloc() : super(CounterState.initial()) {
    // on<IncrementCounterEvent>(_incrementCounter, transformer: sequential());
    //
    // on<DecrementCounterEvent>(_decrementCounter, transformer: sequential());
  ...
  Future<void> _incrementCounter(IncrementCounterEvent event,
      Emitter<CounterState> emit) async {
